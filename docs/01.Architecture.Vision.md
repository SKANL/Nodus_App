...
### C. The Student Node (The Talent)

- **Device:** User's own Smartphone (Web/App).
- **Role:**
  - **Registration:** Scans Event QR to register and generate a Project ID.
  - **Display:** Phone screen acts as the digital "Stand Number" and voting QR.
